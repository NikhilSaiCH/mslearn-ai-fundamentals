...
1. Under **Runtime settings** section, select the Compute type as **Compute instance (1)** and in the **Select Azure ML compute instance** select the running instance by the name **TestComputeMg<inject key="Deployment ID" enableCopy="false"/> (2)** and click on **Next (3)**.
