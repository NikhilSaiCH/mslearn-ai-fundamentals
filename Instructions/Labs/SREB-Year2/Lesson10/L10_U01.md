...
1. Double click on the **Clean Missing Data (1)** and then enter the value `0.7` in the **Fraction of rows in the first output dataset (2)** and click on **Save (3)**.
...
1. In the **Label column** window, set the Label column to **HighVolume (1)** and then click on **Save (2)**.
